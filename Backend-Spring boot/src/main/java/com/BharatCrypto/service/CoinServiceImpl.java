...
public class CoinServiceImpl implements CoinService {
    ...
    // ✅ FIXED: Get paginated coins from CoinCap API with better error handling
    @Override
        ...
        try {
            ...
            for (JsonNode coinNode : data) {
                try {
                    ...
                    System.err.println("⚠️ Failed to parse coin: " + e.getMessage());
                }
            }
    ...
    // ✅ Get coin list from CoinCap API with pagination
    @Override
    ...
    // ✅ Get real-time market chart data from CoinCap API
    @Override
            ...
            if (data != null && data.isArray()) {
                for (JsonNode item : data) {
                    try {
                        ...
                        System.err.println("⚠️ Failed to parse chart point: " + e.getMessage());
                    }
                }
            }
    ...
    // ✅ Get coin details from CoinCap API (real-time)
    @Override
    ...
    // ✅ Find coin by ID from CoinCap API
    @Override
    public Coin findById(String coinId) throws Exception {
        ...
        try {
            ...
            System.out.println("✅ Coin found: " + coin.getName());
            return coin;
        } catch (Exception e) {
    ...
    // ✅ Get top 50 coins from CoinCap API (real-time)
    @Override
    public List<Coin> getTop50CoinsByMarketCapRank() throws Exception {
