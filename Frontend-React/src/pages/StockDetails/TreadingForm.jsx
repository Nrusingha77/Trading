...
const TreadingForm = () => {
  ...
  const handleOnChange = (e) => {
    ...
    setAmount(amount);
    const volume = calculateBuyCost(amount, coin.coinDetails?.priceUsd || 0);
    setQuantity(volume);
  };
    ...
    <div className="space-y-10 p-5">
      <div>
        ...
        {orderType == "SELL"?
          ...
          ):(quantity * (coin.coinDetails?.priceUsd || 0) >
      ...
      <div className="flex gap-5 items-center">
        ...
        <div>
          ...
          {coin.coinDetails && <div className="flex items-end gap-2">
              <p className="text-xl font-bold">${parseFloat(coin.coinDetails.priceUsd).toFixed(2)}</p>
              <p
                className={`${
      ...
      <div className="">
        <DialogClose className="w-full">
          ...
          disabled={
            ...
            (orderType == "SELL"
              ? asset.assetDetails?.quantity * (coin.coinDetails?.priceUsd || 0) < amount
              : quantity * (coin.coinDetails?.priceUsd || 0) >
                wallet.userWallet?.balance)
          }
        >
